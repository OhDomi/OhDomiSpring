...
CREATE TABLE IF NOT EXISTS stores (
    store_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS staff_shifts (
    staff_shift_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS facilities (
    facility_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
    store_id BIGINT NOT NULL,
    name VARCHAR(100) NOT NULL,
    active BOOLEAN NOT NULL DEFAULT TRUE,
...
CREATE TABLE IF NOT EXISTS facility_checks (
    facility_check_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS menu_items (
    menu_item_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS customer_orders (
    customer_order_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
    store_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS customer_order_items (
    customer_order_item_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS inventory_items (
    inventory_item_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
    store_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS purchase_orders (
    purchase_order_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
    store_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS purchase_order_items (
    purchase_order_item_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS order_recommendations (
    recommendation_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
    inventory_item_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS hygiene_inspections (
    inspection_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
    store_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS hygiene_check_results (
    check_result_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS hygiene_images (
    image_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
    inspection_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS improvement_tasks (
    improvement_task_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
    inspection_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS risk_assessments (
    risk_assessment_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
    store_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS board_posts (
    post_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS board_answers (
    answer_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS notifications (
    notification_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
    store_id BIGINT,
...
CREATE INDEX IF NOT EXISTS idx_customer_orders_store_date ON customer_orders(store_id, ordered_at);
CREATE INDEX IF NOT EXISTS idx_purchase_orders_store_date ON purchase_orders(store_id, created_at);
CREATE INDEX IF NOT EXISTS idx_hygiene_store_date ON hygiene_inspections(store_id, inspected_at);
CREATE INDEX IF NOT EXISTS idx_risk_store_date ON risk_assessments(store_id, assessed_at);
CREATE INDEX IF NOT EXISTS idx_board_type_date ON board_posts(board_type, created_at);
